...
wood_bg = pygame.image.load('game_pics/Wood_BG.png')
land_bg = pygame.image.load('game_pics/Land_BG.png')
water_bg = pygame.image.load('game_pics/Water_BG.png')
cloud1 = pygame.image.load('game_pics/Cloud1.png')
cloud2 = pygame.image.load('game_pics/Cloud2.png')
crosshair = pygame.image.load('game_pics/crosshair.png')
duck_surface = pygame.image.load('game_pics/duck.png')
